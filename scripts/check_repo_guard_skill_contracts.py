...
REQUIRED_TEXT = {
    "code-reviewer/SKILL.md": [
        ...
        "The first line must be exactly `## CR Report:",
        "Do not add extra headings outside the output contract",
        "Inline finding bullets must begin with `- [`",
    ...
    "issue-reviewer/SKILL.md": [
        ...
        "Do not ask for alternatives, impact scope, or extra context when the issue is already actionable",
        "Keep all headings and bold marker labels exactly as written",
